...
import type { Project, CreateProjectRequest, UpdateProjectRequest, ListProjectsResponse } from "@/shared/types";
...
export function useUpdateProject() {
  ...
  return useMutation({
    ...
    onError: (_err, _vars, ctx) => {
      ...
      if (ctx?.prevDetail)
        qc.setQueryData(projectKeys.detail(wsId, ctx.id), ctx.prevDetail);
    },
