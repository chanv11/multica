...
export type AppDict = {
  ...
  auth: {
    ...
    authorizeCli: string;
    authorizeCliDescription: string;
    authorize: string;
    authorizing: string;
    useDifferentAccount: string;
    // Callback page strings
    openingApp: string;
    openingAppDescription: string;
    openDesktopApp: string;
    loginFailed: string;
    backToLogin: string;
    signingIn: string;
    signingInDescription: string;
  ...
  onboarding: {
    ...
    // StepRuntime
    connectRuntimeTitle: string;
    connectRuntimeDescription: string;
    installCliLabel: string;
    setupDaemonLabel: string;
    setupCommandDescription: string;
    runtimesConnected: string;
    runtimeConnected: string;
    waitingForConnection: string;
    // StepAgent
    createFirstAgentTitle: string;
    createFirstAgentDescription: string;
    ...
    // StepComplete
    allSetTitle: string;
    allSetDescriptionWithAgent: string;
    allSetDescriptionWithoutAgent: string;
    settingUpWorkspace: string;
    assignedTo: string;
    goToWorkspace: string;
    // Agent templates
    templateMasterAgent: string;
    templateMasterAgentDesc: string;
    templateCodingAgent: string;
    templateCodingAgentDesc: string;
  };
  search: {
    title: string;
    description: string;
  ...
  agents: {
    ...
    tabEnv: string;
    skillsAssignedDesc: string;
    localSkillsHint: string;
    addSkillsHintFull: string;
    loadingRuntimes: string;
    selectRuntime: string;
    envTitle: string;
    envDescription: string;
    envSaved: string;
    failedToSaveEnv: string;
  ...
  comments: {
    ...
    deleteCommentWithReplies: string;
    deleteCommentSingle: string;
    copied: string;
    copy: string;
    edit: string;
    delete: string;
