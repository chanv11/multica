...
const detailTabs: { id: DetailTab; icon: typeof FileText }[] = [
...
const tabLabelKey: Record<DetailTab, keyof Pick<import("../../i18n/types").AppDict["agents"], "tabInstructions" | "tabSkills" | "tabTasks" | "tabSettings" | "tabEnv">> = {
    ...
    <div className="flex h-full flex-col">
      ...
      {isArchived && (
        <div className="flex items-center gap-2 bg-muted/50 px-4 py-2 text-xs text-muted-foreground border-b">
          ...
          <span className="flex-1">{t.agents.archiveBannerText}</span>
          ...
          <DialogContent className="max-w-sm" showCloseButton={false}>
            <div className="flex items-center gap-3">
              ...
              <DialogHeader className="flex-1 gap-1">
                <DialogTitle className="text-sm font-semibold">{t.agents.archiveAgentConfirm}</DialogTitle>
                <DialogDescription className="text-xs">
                  &quot;{agent.name}&quot; {t.agents.archiveConfirmDescription}
                </DialogDescription>
              </DialogHeader>
            </div>
            <DialogFooter>
